...
class UserController{
    ...
    async createUser(reg, res){
        ...
        const newUser = await db.query(`insert into user_tb (name, surename, patronymic, password, email, role, group_tb_id) values ($1, $2, $3, $4, $5, $6) returning *`, [name, surename, patronymic, password, email, role, group_tb_id])
